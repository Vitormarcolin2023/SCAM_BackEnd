...
public class ReuniaoView {
    ...
    public static JInternalFrame visualizarReunioes() {
        ...
        Color verdeUni = new Color(0, 200, 100);
        ...
        painelCentro.setBackground(new Color(50, 50, 50));

        // Filtro
        JPanel painelFiltro = new JPanel(new FlowLayout(FlowLayout.LEFT));
        painelFiltro.setBackground(new Color(50, 50, 50));
        ...
        filtroReuniao.setFont(fontePadrao);
        ...
        painelLista.setBackground(new Color(60, 60, 60));
        ...
        Runnable atualizarLista = () -> {
            ...
            if(reunioes.isEmpty()){
                ...
                msgSemReunioes.setForeground(verdeUni);
                msgSemReunioes.setFont(fontePadrao);
