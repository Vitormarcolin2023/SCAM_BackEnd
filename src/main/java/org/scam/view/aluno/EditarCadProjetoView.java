...
public class EditarCadProjetoView {

        public static JInternalFrame EditarProjeto () {
            JInternalFrame frame = new JInternalFrame("Editar Projetos",true,true,true,true);
            ...
            JLabel titulo = new JLabel("Editar Projeto");
            ...
            gbc.gridy = row++;
            gbc.gridx = 0;
            JLabel nomeLabel = new JLabel("Qual Projeto?");
            nomeLabel.setForeground(Color.WHITE);
            panel.add(nomeLabel, gbc);

            gbc.gridx = 1;
            JComboBox<String> editarCombo = new JComboBox<>(new String[] {"MonitorIA", "EcoTrack", "MentorLink"});
            panel.add(editarCombo, gbc);
            ...
            atualizarButton.setPreferredSize(new Dimension(150, 30));
